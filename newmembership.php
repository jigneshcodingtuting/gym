	...
	<body bgcolor="#ebebe0">
		...
		<center>
			...
			<div class="container-fluid">
					...
					if(isset ($_SESSION["err"]) && $_SESSION["err"]==2)
					{
						echo	"<div class='alert alert-danger' style='width:550px'>
										...
										<center>
											...
											Oops!!! Sorry membership not added. Please try again.
										</center>
									</div>";
					}
				...
				<form action="newmembership_data" method="post" name="membership" onsubmit="return message();">
				
					<script>
						
						function message()
						{
							var a = document.membership.memtype.value;
							
							if(a=="")
							{
								alert("Please enter Typer Of Membership.");
								return false;
							}
						}
					...
					<table class="table table-hover table-bordered" style="width:550px">
						<tr>
							<td colspan="2" align="center">
								<h2> <b> Add New Membership </b> </h2>
							</td>
						</tr>
						<tr>
							<td align="right"><b>Membership Type:</b></td>
							<td><input type="text" class="form-control" name="memtype" placeholder="Enter Type of Membership"></td>
						</tr>
